<?php get_header(); ?>
		...
		<div class="inner">
			...
			<ul class="menu expanded">
				<li class="menu--other-events">
					<ul>
						<li class="current"><a href="/boston-2016"><span class="location">Boston</span><span
									class="date">3rd November 2016</span></a></li>
						<li><a href="/Tokyo-2017"><span class="location">Tokyo</span><span class="date">00th September 2017</span></a>
						</li>
						<li>
							<ul class="past-events">
								<li><span class="past-events--label">Past Events</span></li>
								<li><a href="/boston-2016"><span class="location">Boston</span><span class="date">3rd September 2016</span></a>
								</li>
							</ul>
						</li>
					</ul>
	...
	<div class="Page">
		<section class="Intro">
			<div class="inner">
				<img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/ador-boston-logo.png"
				     title="A Day of Rest Boston"/>
				<h2>Learn about the <strong>WordPress REST API </strong>from the team building it and the people using
					it. 3rd November 2016, CIT Building, Boston.</h2>
				<a href="#" class="Button buynow">Get your ticket</a>

				<video autoplay loop muted
				       poster="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/poster.png" id="video">
					<source src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/dayofrest.mp4"
					        type="video/mp4">
				</video>
			</div>
		</section>
		...
		<section class="Speakers">
			<div class="inner">
				...
				<p>Some intro copy will go here with value propositions and to introduce the execellent speakers, this
					intro is specifically for the main event day.</p>
			</div>
		</section>
		...
		<section class="Testimonials">
			<div class="inner">
				<ul class="testimonial-slider">
					<li class="testimonial"><img src="https://randomuser.me/api/portraits/men/80.jpg" alt=""
					                             class="avatar">
						<blockquote>It was a great conference - really engaging speakers from a range of organisations
							around the world, and a good chance to network with other developers. I was impressed by how
							many core WordPress / REST API contributors came along, too
						</blockquote>
		...
		<div class="Sponsors">
			<div class="inner">
				...
				<section class="sponsor-level platinum">
					...
					<ul>
						<li><a href="#"><img
									src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/hm-logo.png"
									alt="#"></a></li>
						<li><a href="#"><img
									src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/ps-logo.png"
									alt="#"></a></li>
					</ul>
				</section>
		...
		<section class="Community">
			<div class="inner">
				<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/ador-icon.png' ); ?>"
				     alt="">
		...
		<section class="BuyYourTicket">
			<div class="inner">
				...
				<p>Want to join us for some REST in November? Who wouldn't? General Tickets cover the event itself,
					including lunch, breaks, swag and a fun after-party.</p>
