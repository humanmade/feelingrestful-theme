...
module.exports = React.createClass({
	...
	render: function() {
		return (
			<div className="App">
				<Menu isExpanded={this.props.display.showingMenu} onToggle={this.handleToggleMenu} currentPath={this.props.location.pathname} menu={this.props.menu} dispatch={this.props.dispatch} onClick={this.handleClickMenuItem} isShowingOtherEvents={this.props.display.showingOtherEventsMenu}/>
