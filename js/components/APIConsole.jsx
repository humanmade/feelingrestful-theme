			...
			<div>
				{this.props.isExpanded
					? <div className="api-display-wrap">
						<div className="api-display">
							<p>This page was rendered using the WP REST API, below we show the request and response data
								that was made.</p>
				...
				<div className="APIConsole">
					<div onClick={this.props.onExpand} className="api-cta">
						<span className={'fa fa-chevron-' + (
							this.props.isExpanded ? 'down' : 'up'
					...
					<div className="api-output">
						...
						{Api.lastRequest.isLoading
							? 'Loading...'
							: <span> <span
								className="fa fa-long-arrow-right"></span> {JSON.stringify( Api.lastRequest.data )}</span>
						}
					</div>
				</div>
			</div>
