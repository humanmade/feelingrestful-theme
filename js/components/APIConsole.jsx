			...
			<div>
				{this.props.isExpanded
					?	<div className="api-display-wrap">
							<div className="api-display">
								...
								<pre>{Api.lastRequest.method} <a href={app_data.base + '/wp-json' + Api.lastRequest.url}>{Api.lastRequest.url} {JSON.stringify( Api.lastRequest.args )}</a></pre>
				...
				<div className="APIConsole">
					...
					<div className="api-output">
					 	{Api.lastRequest.method} <a href={app_data.base + '/wp-json' + Api.lastRequest.url}>{Api.lastRequest.url}</a>
